    ...
    <div className={css.info_wrapper}>
      ...
      <div className={css.detailed_descr_wrapper}>
        ...
        <p className={css.detailed_descr}>
          ...
          можна розрізнити крихітні коліна, лікті та зап&apos;ястя. На ручках та
          ніжках зникають перетинки між пальцями, а на їхніх кінчиках
          з&apos;являються основи для майбутніх нігтиків.
        </p>
      </div>
      <div className={css.fact_of_the_week_wrapper}>
        ...
        <div className={css.fact_of_the_week_text_wrapper}>
          <p className={css.fact_of_the_week_text}>
            Малюк вже активно рухається, згинаючи ручки та ніжки, хоча ви цього
            ще не можете відчути.
          </p>
        </div>
      </div>
    </div>
